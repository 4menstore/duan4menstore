...
public class DotGiamGiaController {
    ...
    public Page<DotGiamGia> getAll(
        ...
        return dotGiamGiaService.getAll(keyword, trangThai, tuNgay, denNgay, pageable);
    }
    ...
    public DotGiamGia toggleStatus(@PathVariable Integer id) {
        DotGiamGia dot = dotGiamGiaService.findById(id);
        DotGiamGiaRequest request = toRequest(dot);
        request.setTrangThai(!Boolean.TRUE.equals(dot.getTrangThai()));
        request.setSelectedSpctIds(dotGiamGiaService.getSelectedSpctIds(id));
        return dotGiamGiaService.save(request);
    }
